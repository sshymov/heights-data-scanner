...
public class ThresholdScannerTest extends TestCase {
    ...
    public void testDetectOnePointHeight() throws IOException {
        ...
        assertEquals(0, thresholdScanner.scanNotFixed(20, 61, Direction.NE).size());
        assertEquals(1, thresholdScanner.scanNotFixed(20, 60, Direction.NE).size());
    }
    ...
    public void testDetectFivePointHeight() throws IOException {
        ...
        assertEquals(100, (int) result.get(new MatrixCoordinate(1, 5)));
    }
}