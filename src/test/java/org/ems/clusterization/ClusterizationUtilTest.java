...
public class ClusterizationUtilTest {
    ...
    public void testClusterizationForOnePoint() {
        ...
        List<List<Point>> clusters = ClusterizationUtil.clusterize(Lists.newArrayList(point), 2);

        assertEquals(1, clusters.size());
        assertEquals(1, clusters.get(0).size());
        assertSame(clusters.get(0).get(0), point);
    }

    @Test
    public void testClusterizationForTwoClusters() {
        List<List<Point>> clusters = ClusterizationUtil.clusterize(
